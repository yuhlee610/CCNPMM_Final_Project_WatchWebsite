	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
				<div class="single-new-pro mb-30 text-center">
					<div class="product-img">
						<img src="./resources/assets/img/gallery/new_product2.png" alt="">
					</div>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
				<div class="single-new-pro mb-30 text-center">
					<div class="product-img">
						<img src="./resources/assets/img/gallery/new_product3.png" alt="">
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
					<div class="single-popular-items mb-50 text-center">
						...
						<div class="popular-caption">
							<h3>
								<a href="detail?productId=${p.getId() }">${p.getName() }</a>
							</h3>
...
<div class="watch-area section-padding30">
	<div class="container">
		<div
			...
			<div class="col-lg-6 col-md-6 col-sm-10">
				<div class="choice-watch-img mb-40">
					<img src="./resources/assets/img/gallery/choce_watch1.png" alt="">
				</div>
			</div>
		</div>
		<div class="row align-items-center justify-content-between">
			<div class="col-lg-6 col-md-6 col-sm-10">
				<div class="choice-watch-img mb-40">
					<img src="./resources/assets/img/gallery/choce_watch2.png" alt="">
				</div>
			</div>
			<div class="col-lg-5 col-md-6">
				<div class="watch-details mb-40">
