				...
				<div class="login_part_form">
					<div class="login_part_form_iner">
						...
						<form id="register-form" class="row contact_form" action="register" method="post" modelAttribute="user" 
							...
							<div class="col-md-12 form-group p_star">
								<input type="password" class="form-control" id="password" minlength="4" maxlength="20"
									name="password" value="" placeholder="Password" required>
							</div>
							<div class="col-md-12 form-group p_star">
								<input type="password" class="form-control" id="confirmPassword" minlength="4" maxlength="20"
									name="confirmPassword" value="" placeholder="Confirm Password" required>
							</div>
							<div class="col-md-12 form-group p_star">
								<input type="text" class="form-control" id="name" name="name" minlength="4" maxlength="20"
									value="" placeholder="Name" required>
							</div>
							<div class="col-md-12 form-group p_star">
								<input type="text" class="form-control" id="address" name="address" minlength="6" maxlength="50"
									value="" placeholder="Address" required>
							</div>
							<div class="col-md-12 form-group p_star">
